...
/****** Object:  Table [dbo].[Debts]    Script Date: 3/12/2015 1:54:26 PM ******/
...
CREATE TABLE [dbo].[Debts](
	...
	[Payer_Id] [int] NULL,
	[Receiver_Id] [int] NULL,
 CONSTRAINT [PK_dbo.Debts] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
ALTER TABLE [dbo].[Debts]  WITH CHECK ADD  CONSTRAINT [FK_dbo.Debts_dbo.Users_Payer_Id] FOREIGN KEY([Payer_Id])
REFERENCES [dbo].[Users] ([Id])
GO

ALTER TABLE [dbo].[Debts] CHECK CONSTRAINT [FK_dbo.Debts_dbo.Users_Payer_Id]
GO

ALTER TABLE [dbo].[Debts]  WITH CHECK ADD  CONSTRAINT [FK_dbo.Debts_dbo.Users_Receiver_Id] FOREIGN KEY([Receiver_Id])
REFERENCES [dbo].[Users] ([Id])
GO

ALTER TABLE [dbo].[Debts] CHECK CONSTRAINT [FK_dbo.Debts_dbo.Users_Receiver_Id]
GO
